...
(function () {
  ...
  if (!reduce && window.matchMedia("(hover: hover)").matches) {
    $$(".svc-card, .why-card, .aud-card, .pillar, .sec-item").forEach(function (card) {
  ...
  var DATA = {
    ...
    "Seguridad Informática": {
      ...
      features: ["Firewalls de nueva generación", "Protección avanzada de endpoints y antivirus", "VPN segura para acceso remoto", "Filtrado web y control de aplicaciones", "Monitoreo y respuesta ante incidentes 24/7"],
